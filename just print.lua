...
local function print_t3mujin_styles()
  dt.print("Shortcut triggered!")  -- ✅ Always prints

  local all_styles = dt.styles.get_names()
  dt.print("Checking styles...")  -- ✅ Confirms function runs
...
dt.register_event("list_t3mujin_styles_debug", "shortcut",
  print_t3mujin_styles,
  "Print and debug available t3mujin styles"
)
